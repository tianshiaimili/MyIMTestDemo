...
public class RosterProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "com.hua.im.provider.Roster";
	...
	public boolean onCreate() {
		LogUtils2.i("***************RosterProvider oncreate");
	...
	public Cursor query(Uri url, String[] projectionIn, String selection,
		...
		if (ret == null) {
			...
			//可参考 http://blog.csdn.net/koko7958/article/details/7164255
			//大概意思是说 ，因为有ContentResolver 注册监听了这个URI ，所以当注册监听的表发生insert，update，query 等操作时，都会通知对应的
			//ContentResever 然后调用onChange（）方法做改变
	...
	private static class RosterDatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			...
			LogUtils2.i("***creating new roster table");
