...
import com.hua.activity.BaseActivity.BackPressHandler;
import com.hua.activity.LoginActivity;
import com.hua.activity.MainActivity;
...
import com.hua.smack.SmackImpl;
import com.hua.util.L;
import com.hua.util.LogUtils2;
import com.hua.util.NetUtil;
import com.hua.util.PreferenceUtils;
import com.hua.util.T;

public class ActionService extends BaseService implements EventHandler,
		BackPressHandler {
	...
	private static final String RECONNECT_ALARM = "com.hua.im..RECONNECT_ALARM";
	...
	public IBinder onBind(Intent intent) {
		L.i(ActionService.class, "[SERVICE] onBind");
		LogUtils2.i("**********bind the service..");
		String chatPartner = intent.getDataString();
		LogUtils2.i("****chatPartner = "+chatPartner);
		if ((chatPartner != null)) {
	...
	public void onRebind(Intent intent) {
		...
		LogUtils2.w("**********onRebind the service..");
		String chatPartner = intent.getDataString();
		if ((chatPartner != null)) {
			mIsBoundTo.add(chatPartner);
		}
	...
	public boolean onUnbind(Intent intent) {
		LogUtils2.w("**********onUnbind the service..");
		String chatPartner = intent.getDataString();
		if ((chatPartner != null)) {
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		if (intent != null
			...
			String account = PreferenceUtils.getPrefString(ActionService.this,
					PreferenceConstants.ACCOUNT, "");
			String password = PreferenceUtils.getPrefString(ActionService.this,
	...
	public void Login(final String account, final String password) {
		...
		mConnectingThread = new Thread() {
			...
			public void run() {
				try {
					postConnecting();
					mSmackable = new SmackImpl(ActionService.this);
					...
					L.i(ActionService.class, "YaximXMPPException in doConnect():");
					e.printStackTrace();
				} finally {
					if (mConnectingThread != null)
	...
	private void connectionFailed(String reason) {
		L.i(ActionService.class, "connectionFailed: " + reason);
		...
		if (PreferenceUtils.getPrefBoolean(this,
			...
			L.d("connectionFailed(): registering reconnect in "
					+ mReconnectTimeout + "s");
			LogUtils2.e("connectionFailed(): registering reconnect in  "+mReconnectTimeout+"s");
	...
	public void newMessage(final String from, final String message) {
		mMainHandler.post(new Runnable() {
			public void run() {
				if (!PreferenceUtils.getPrefBoolean(ActionService.this,
						PreferenceConstants.SCLIENTNOTIFY, false))
					MediaPlayer.create(ActionService.this, R.raw.office).start();
