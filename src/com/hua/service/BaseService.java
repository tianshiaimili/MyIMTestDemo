...
//		LogUtils2.i(message);
	...
	public boolean onUnbind(Intent intent) {
		LogUtils2.i("called onUnbind()");
		return super.onUnbind(intent);
	}

	@Override
	public void onRebind(Intent intent) {
		LogUtils2.i("called onRebind()");
		super.onRebind(intent);
	}

	@Override
	public void onCreate() {
		LogUtils2.i("called onCreate()");
		super.onCreate();
	...
	public void onDestroy() {
		LogUtils2.i("called onDestroy()");
		super.onDestroy();
	}

	@Override
	public int onStartCommand(Intent intent, int flags, int startId) {
		LogUtils2.i("called onStartCommand()");
		return START_STICKY;
	}
